...
class _ProductCategoryScreenState extends State<ProductCategoryScreen> {
  List<Map<String, dynamic>> listData = [
    {"ID": 1, "brand_name": "Product A"},
    {"ID": 2, "brand_name": "Product B"},
    {"ID": 3, "brand_name": "Product C"},
    {"ID": 4, "brand_name": "Product D"},
    {"ID": 5, "brand_name": "Product E"},
    {"ID": 6, "brand_name": "Product F"},
    {"ID": 7, "brand_name": "Product G"},
    {"ID": 8, "brand_name": "Product H"},
    {"ID": 9, "brand_name": "Product I"},
    {"ID": 10, "brand_name": "Product J"},
  ];
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text("Product Category: ", style: FTextStyle.listTitle),
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          title: Text(
            index == -1 ? "Add Product Category" : "Edit Product Category",
            ...
            child: Column(
              ...
              children: [
                TextFormField(
                  ...
                  decoration: InputDecoration(
                      hintText: index == -1 ? "Enter new product category" : "Update product category",
                    hintStyle: FTextStyle.formhintTxtStyle,
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(23.0),
                      borderSide: const BorderSide(color: AppColors.FormFieldHintColour, width: 1.0),
