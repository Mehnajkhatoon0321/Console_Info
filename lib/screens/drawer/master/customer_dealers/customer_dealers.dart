...
class CustomersDealersScreen extends StatefulWidget {
  const CustomersDealersScreen({super.key});

  @override
  State<CustomersDealersScreen> createState() => _CustomersDealersScreenState();
}

class _CustomersDealersScreenState extends State<CustomersDealersScreen>{
  List<Map<String, dynamic>> listData = [
    {"name": "Mehnaj khan", "userType": "customer", "whatsapp": "9695844884","email":"mehnaj@mailinator.com"},
    {"name": "Swati", "userType": "dealer", "whatsapp": "941585444543","email":"mehnaj@mailinator.com"},

    {"name": "Mehnaj khan", "userType": "customer", "whatsapp": "9695844884","email":"mehnaj@mailinator.com"},
    {"name": "Swati", "userType": "dealer", "whatsapp": "941585444543","email":"mehnaj@mailinator.com"},
    {"name": "Mehnaj khan", "userType": "customer", "whatsapp": "9695844884","email":"mehnaj@mailinator.com"},
    {"name": "Swati", "userType": "dealer", "whatsapp": "941585444543","email":"mehnaj@mailinator.com"},    {"name": "Mehnaj khan", "userType": "customer", "whatsapp": "9695844884","email":"mehnaj@mailinator.com"},
    {"name": "Swati", "userType": "dealer", "whatsapp": "941585444543","email":"mehnaj@mailinator.com"},    {"name": "Mehnaj khan", "userType": "customer", "whatsapp": "9695844884","email":"mehnaj@mailinator.com"},
    {"name": "Swati", "userType": "dealer", "whatsapp": "941585444543","email":"mehnaj@mailinator.com"},    {"name": "Mehnaj khan", "userType": "customer", "whatsapp": "9695844884","email":"mehnaj@mailinator.com"},
    {"name": "Swati", "userType": "dealer", "whatsapp": "941585444543","email":"mehnaj@mailinator.com"},
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text("${listData[index]["name"]}", style: FTextStyle.listTitleSub),
                          ],
                        ),
                        const SizedBox(height: 5),
                        Row(
                          children: [
                            const Text("UserType: ", style: FTextStyle.listTitle),
                            Text("${listData[index]["userType"]}", style: FTextStyle.listTitleSub),
                          ],
                        ),
                        const SizedBox(height: 5),  Row(
                          children: [
                            const Text("Whatsapp: ", style: FTextStyle.listTitle),
                            Text("${listData[index]["whatsapp"]}", style: FTextStyle.listTitleSub),
                          ],
                        ),
                        const SizedBox(height: 5),
                        Row(
                          children: [
                            ...
                            Text("${listData[index]["email"]}", style: FTextStyle.listTitleSub),
                          ],
                        ),
                        const SizedBox(height: 5),
                        Row(
                              ...
                              onPressed: () {
                                Navigator.push(context, MaterialPageRoute(builder:(context) => CustomerEdit(
                                  screenFlag :"edit",
                                    ...
                                    usertype:listData[index]["userType"],
                                    whatsapp:listData[index]["whatsapp"],
